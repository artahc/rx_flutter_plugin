...
class ObservableStreamController<T> {
  ...
  ObservableStreamController(StreamType type, {void onListen()?, onCancel()?, bool sync: false}) {
    this._type = type;
    this._controller = StreamController(onListen: onListen, onCancel: onCancel);
  }
